...
export default function AdminLoginNav() {
  ...
  useEffect(() => {
    ...
    setIsLoginPage(path.includes('/admin/login') || path === '/admin');
  ...
  // Simplified navigation with just the logo, no menu items
  const logoSize = isMobile ? 130 : 142;
