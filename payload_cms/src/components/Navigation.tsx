    ...
    <>
      ...
      >
        ...
        >
          ...
          >
            <Link href="/" aria-label="Litecoin Knowledge Hub" style={{ display: 'flex', alignItems: 'center' }}>
              <div
                style={{
                  position: 'relative',
                  marginLeft: isMobile ? '0.5rem' : '0.25rem',
                  marginTop: '3px',
                  height: `${logoSize}px`,
                  width: `${logoSize}px`,
          ...
          <nav>
            {isMobile ? (
              <div
                className={`nav-toggle ${navShow ? 'open' : ''}`}
              ...
              <ul style={{ display: 'flex', flexDirection: 'row', listStyle: 'none', margin: 0, padding: 0 }}>
                ...
                >
                  <Link href="/contributors" style={{ color: 'inherit', textDecoration: 'none' }}>Contributors</Link>
                </li>
                <li
                  style={{
                    color: fontColor,
                ...
                >
                  <Link href="/publishers" style={{ color: 'inherit', textDecoration: 'none' }}>Publishers</Link>
                </li>
                <li
                  style={{
                    color: fontColor,
                ...
                >
                  <Link href="/tips" style={{ color: 'inherit', textDecoration: 'none' }}>Tips</Link>
                </li>
                <li
                  style={{
                    color: fontColor,
      ...
      <div
        className={`mobile-menu ${navShow ? 'open' : ''}`}
        style={{
          backgroundColor: interpolateColor('#C5D3D6', '#222222', bgOpacity),
        }}
      >
        <div style={{ display: 'flex', flexDirection: 'column' }}>
          <nav style={{ marginTop: '2.5rem', height: '100%' }}>
            {[
              { title: 'Home', link: '/' },
              { title: 'Contributors', link: '/contributors' },
              { title: 'Publishers', link: '/publishers' },
