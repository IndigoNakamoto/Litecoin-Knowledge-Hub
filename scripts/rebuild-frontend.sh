#!/bin/bash
# Helper script to rebuild and restart only the frontend service
# This is useful during development when you only need to update frontend code
...
# Pass build args for NEXT_PUBLIC_* variables (required for frontend build)
...
# Stop and remove the frontend container, then start it again
...
echo ""
echo "📋 Checking frontend logs (Ctrl+C to exit)..."
echo ""
